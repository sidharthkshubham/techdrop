...
exports.bloggen = async (title) => {
  ...
  const prompt = `
You are an expert journalist, storyteller, and SEO strategist with real-world experience in technology and AI trends.

Your task is to write a 100% original, deeply engaging, and human-sounding blog article based on the title:

"${title}"
The goal is to create content that feels researched, personal, and written by a human expert — not AI.
...
Writing Style Rules:
- Write as if you are a **human journalist**, not an AI.
- Start with a **strong hook** — use curiosity, emotion, or a surprising fact.
- Avoid robotic phrases like “In today’s world” or “With the rise of technology.”
- Include **at least one personal insight, case study, or real-world example**.
- Mention **specific data, reports, or expert opinions** (e.g., from Gartner, McKinsey, or Microsoft blogs) — make them sound authentic.
- Use **mixed sentence lengths** and **natural tone shifts**.
- Add **rhetorical questions** or **relatable remarks** where it makes sense.
- Include **1–2 credible external links** to authority sites.
- Structure with clear <h2> and <h3> sections for readability.
- End with a **human-style conclusion** — insightful or motivational.
- Include an **FAQ section** with practical, user-focused questions.
- Make it SEO-friendly but conversational — prioritize clarity over keyword stuffing.

💡 Personality Tips:
Write like a tech-savvy storyteller who’s sharing honest observations with readers — think of how a medium.com writer would explain things.

The output must be ONLY valid JSON (no markdown, no explanations, no extra text).
do not add any markdown syntax in the starting of the code 
`;
